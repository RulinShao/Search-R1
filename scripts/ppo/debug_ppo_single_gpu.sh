...
export EXPERIMENT_NAME=debug-gpqa-0.5b
...
PYTHONUNBUFFERED=1 python3 -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.actor.fsdp_config.optimizer_offload=16 \
    ...
    do_search=true \
    max_turns=2 \
    retriever.url="http://rulin@a100-st-p4de24xlarge-23:41383/retrieve" \
    retriever.topk=3 \
